        ...
        if(isset($_GET['user'])){
          ...
          if($sem==1 || $sem==2 || $sem==6)
            ...
            $sql = "INSERT INTO marks(uid, name, usn, sem, branch, sub1, mrk1, sub2, mrk2, sub3, mrk3, sub4, mrk4, sub5, mrk5, sub6, mrk6, sub7, mrk7) 
                    VALUES ('$uid', '$name', '$usn', '$sem', '$branch', '$sub1', '$mrk1', '$sub2', '$mrk2', '$sub3', '$mrk3', '$sub4', '$mrk4', '$sub5', '$mrk5', '$sub6', '$mrk6', '$sub7','$mrk7')";
          else
...
<section>
  ...
  <div id="login">
    ...
    <form name="f2" action="" onsubmit = "return validation()"  method="post">
        <table>
            <tr>
            <td>Name:<input type="text"  id="name" name="name" placeholder="Full Name" required pattern="[A-Z* a-z*]{1,}" title="Enetr your Name"></td>
            ...
            <td>Marks:<input type="text"  id="mrk6" name="mrk6" placeholder="Marks Obtained"  title="Enter Marks between 0-100"></td>
            </tr>
            <tr>
